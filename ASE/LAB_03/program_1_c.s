...
loop:   nop
        ...
        daddui R11, R11, -8 # vector index
        l.d F3, V3(R11)     # load V3 element
        l.d F1, V1(R11)     # load V1 element 
        
        dmulu R12, R12, R13 # RAW di R12 

        l.d F2, V2(R11)     # load V2 element
        bne  R13, R12, else1  # RAW R12 
        nop
        # if
        dsllv  R14, R14, R10  # m << i
        mtc1  R14, F8         # (double)m<<i RAW di F14
        # cvt.d.l F8,F8         # (double)m<<i # WAR di F8 
        cvt.d.l F10,F8         # (double)m<<i 
